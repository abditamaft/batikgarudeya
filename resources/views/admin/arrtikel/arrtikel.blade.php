                    ...
                    <table class="w-full text-left border-collapse">
                        ...
                        <tbody class="divide-y text-gray-700">
                            ...
                            <tr class="hover:bg-gray-50">
                                ...
                                <td class="p-4"><span class="px-2 py-1 bg-blue-100 text-blue-700 text-xs rounded">{{$article->category->name}}</span></td>
                                <td class="p-4"><span class="text-green-600"><i class="fas fa-check-circle mr-1"></i> {{$article->created_at}}</span></td>
                                <td class="p-4 text-sm">{{$article->views}}</td>
                                <td class="p-4 text-center space-x-2 flex justify-end">
                                    <a href="{{ route('admin.artikel.edit',$article->id) }}" class="text-blue-500 hover:text-blue-700"><i class="fas fa-edit"></i></a>
